...
for i, category in enumerate(categories):
    ...
    cumulative_net_change = category_data['net_change'].cumsum()
    ax.plot(category_data['rent_time'], cumulative_net_change, marker='o', label=category, color=colors[i])

ax.set_xlabel('Period of time')
ax.set_ylabel('Cumulative number of Rent-Return')
...
plt.savefig('Combined cumulative net change graph.png')
